    ...
    while True:
        try:
            ...
            #CONFIG MENU
                ...
                '''
                SAMPLE VERSION: Can commit passwords, but not configs
...
def loadConfig(configFile):
    ...
    try:
        ...
        print ('SAMPLE CODE FROM Github.com/RcKeller')
        print ('Full code available upon request')
        
        
        time.sleep(5)   #Let the system grab an available IP
        recordProvision(configFile)
        print('Config complete.\nPlease perform a graceful shutdown. (Menu #5)')
...
def recordProvision(configFile):
    '''Records the model/serial/config file/mac/ip/subnet of a switch in a spreadsheet'''
